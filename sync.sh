...
$IS_BACKUP  && $exec cp -r $TARGET/.config/nvim/{lua,coc-settings.json,ultisnips} $DOTFILES_DIR/.config/nvim/
$IS_BACKUP  && $exec cp -r $TARGET/.config/goneovim $DOTFILES_DIR/.config/goneovim
