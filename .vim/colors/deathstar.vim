...
" Author: Gustavo Brito ( github.com/GustavoKatel  )
" Based on hipster theme by Conner
if version > 580
   hi clear
   if exists("syntax_on")
      syntax reset
...
hi MatchParen     guifg=#eae788   guibg=#857b6f   guisp=NONE      gui=bold   ctermfg=228    ctermbg=NONE   cterm=bold
...
hi VertSplit      guifg=NONE      guibg=#444444   guisp=NONE      gui=NONE   ctermfg=NONE    ctermbg=238    cterm=NONE
